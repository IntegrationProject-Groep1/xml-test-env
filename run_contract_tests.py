...
DESTINATIONS = {
    ...
    ("frontend", "cancel_registration"): ("planning.session.events", "calendar.exchange", "frontend.to.planning.cancel_registration"),
    ...
    ("kassa", "payment_status"): ("frontend.incoming", "kassa.exchange", "kassa.frontend.payment"),
    ("kassa", "invoice_request"): ("facturatie.incoming", "", ""),
    ("kassa", "wallet_balance_update"): ("frontend.incoming", "kassa.exchange", "kassa.frontend.wallet"),
    ...
    ("crm", "send_mailing"): ("mailing.incoming", "", ""),
    ("crm", "cancel_registration"): ("planning.session.events", "calendar.exchange", "crm.to.planning.cancel_registration"),
    ("crm", "profile_update"): ("facturatie.incoming", "", ""),
    ("crm", "session_registration_confirmed"): ("planning.session.events", "calendar.exchange", "crm.to.planning.session_registration_confirmed"),
    ("crm", "wallet_balance_update"): ("frontend.incoming", "wallet.updates", ""),
    ("crm", "payment_registered"): ("facturatie.incoming", "", ""),
    ("crm", "vat_validation_error"): ("frontend.incoming", "", ""),
    ...
    ("facturatie", "invoice_status"): ("crm.incoming", "", ""),
    ("facturatie", "invoice_available"): ("frontend.incoming", "", ""),
    ("facturatie", "send_mailing"): ("mailing.incoming", "", ""),
    ("facturatie", "payment_registered"): ("crm.incoming", "", ""),
    ("identity", "user_created"): ("", "user.events", ""),
    ("monitoring", "alert"): ("mailing.incoming", "", ""),
    ("monitoring", "vat_validation_error"): ("frontend.incoming", "", ""),
    ("mailing", "mailing_status"): ("crm.incoming", "", ""),
    ("*", "log"): ("logs", "", ""),
    ("*", "heartbeat"): ("heartbeat", "", ""),
    ("*", "system_error"): ("logs", "", ""),
}
