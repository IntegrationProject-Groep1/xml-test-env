...
DESTINATIONS = {
    ...
    ("kassa", "payment_status"): ("frontend.payments", "kassa.exchange", "kassa.frontend.payment"),
    ("kassa", "invoice_request"): ("facturatie.incoming", "", ""),
    ("kassa", "wallet_balance_update"): ("frontend.payments", "kassa.exchange", "kassa.frontend.wallet"),
    ...
    ("crm", "session_registration_confirmed"): ("planning.calendar.invite", "calendar.exchange", "crm.to.planning.session_registration_confirmed"),
